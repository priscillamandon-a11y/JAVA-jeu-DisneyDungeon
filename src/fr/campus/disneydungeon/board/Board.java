package fr.campus.disneydungeon.board;
...
import fr.campus.disneydungeon.equipement.offensive.weapon.SultanSword;
import fr.campus.disneydungeon.board.cases.*;
...
public class Board {
    ...
    public void buildBoard (){
        cells.add(new EmptyCell(0)); // case 0 (vide)
        cells.add(new EmptyCell(1)); // case 1 (vide)
        cells.add(new EnemyCell(2,new ProwlerOfTheRuins())); // case 2 (ennemi)
        cells.add(new WeaponCell(3,new SultanSword())); // case 3 (arme)
        cells.add(new PotionCell(4,new BiscuitSimba())); // case 4 (potion)
